...
try {
    ...
    $queries = [
        ...
        'justificaciones_erradas' => "SELECT numero_ticket, motivo_parada, descripcion_apertura_o_parada 
                                    ...
                                    WHERE bandera = 'P' 
                                    AND prioridad IN ('1', '2')
                                    AND CHAR_LENGTH(descripcion_apertura_o_parada) <= 30
                                    AND (
                                        (motivo_parada = 'Atribuible Terceros  Sin contacto con CD' AND 
                                        ...
                                        OR (motivo_parada IN ('Atribuible Terceros  Falla Energía Eléctrica en CD', 'Atribuible Terceros  Falla Energia Electrica en CD') AND
                                        ...
                                        OR (motivo_parada IN ('Continuidad servicio  Instalaciones no disponibles  Fuera de horario', 'Continuidad servicio  Instalaciones no disponibles Fuera de horario') AND
                                            ...
                                            descripcion_apertura_o_parada NOT LIKE '%Fuera Horario%' AND
                                            descripcion_apertura_o_parada NOT LIKE '%Fuera horario%' AND
                                            descripcion_apertura_o_parada NOT LIKE '%Horario no hábil%' AND /*Verificar si esta es validad para fuera de horarios*/

    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="content-area">
            ...
            <div class="tab-content" id="tab-sitios">
                ...
                <div class="audit-grid">
                    <!-- IDs de Beneficiarios Vacíos - OCUPA TODA LA FILA -->
                    <div class="audit-card" style="grid-column: 1 / -1;">
                        <div class="card-header">
                            <span class="card-title">
                                <i class='bx bx-map-pin'></i>
                    ...
                    <!-- NUEVA TABLA: Comparación ID Beneficiario con Título -->
                    <div class="audit-card" style="grid-column: 1 / -1;">
                        <div class="card-header">
                            <span class="card-title">
                                <i class='bx bx-compare'></i>
                                Comparación ID Beneficiario con Título
                            </span>
                            <span class="card-badge" id="badge-comparacion_id_titulo">0</span>
                        </div>
                        <div class="card-body">
                            <div class="table-wrapper" style="max-height: 400px;" id="table-comparacion_id_titulo">
                                <div class="loading">
                                    <i class='bx bx-loader'></i>
                                    <p>Cargando datos...</p>
                                </div>
                    ...
                    <div class="audit-card" style="grid-column: 1 / -1;">
                        <div class="card-header">
                            <span class="card-title">
                                <i class='bx bx-error-circle'></i>
                                IDs en Descripción No Encontrados en Base CIS
                            </span>
                            <span class="card-badge" id="badge-ids_descripcion_no_encontrados">0</span>
                        </div>
                        <div class="card-body">
                            <div class="table-wrapper" style="max-height: 400px;" id="table-ids_descripcion_no_encontrados">
                                <div class="loading">
                                    <i class='bx bx-loader'></i>
                                    <p>Cargando datos...</p>
                                </div>
                    ...
                    <!-- Tabla existente de Sitios No Encontrados -->
                    <div class="audit-card" style="grid-column: 1 / -1;">
                        <div class="card-header">
                            <span class="card-title">
    ...
    <script>
        ...
        function loadTabData(tabId) {
            const tables = {
                ...
                'sitios': ['tabla3', 'comparacion_id_titulo', 'ids_descripcion_no_encontrados', 'sitios_no_encontrados']
            };
        ...
        function loadStats() {
            ...
            const tables = ['km3201', 'tabla2', 'kms_no_correspondientes', 'responsabilidad_km', 
                          'tabla3', 'comparacion_id_titulo', 'ids_descripcion_no_encontrados', 'incidente_mayor', 'fallas_masivas_un_ci'];
            ...
            tables.forEach(tableId => {
                ...
                if (badge) {
                    ...
                    } else if (tableId === 'tabla3' || tableId === 'comparacion_id_titulo' || tableId === 'ids_descripcion_no_encontrados') {
                        sitiosVacios += count;
        ...
        function renderTableModern(tableId, data) {
            const config = {
                ...
                'ids_descripcion_no_encontrados': {
                    ...
                    headers: ['ID Beneficiario', 'Descripción', 'ID No Encontrado', 'ID Incidente']
                }
            };
            ...
            data.rows.forEach(row => {
                ...
                tableConfig.columns.forEach(column => {
                    ...
                    // Aplicar colores específicos para comparacion_id_titulo
                    if (tableId === 'comparacion_id_titulo') {
                        if (column === 'estado_comparacion' && value === 'NO COINCIDE') {
                            value = `<span class="text-red">${value}</span>`;
                        } else if (column === 'estado_comparacion' && value === 'COINCIDE') {
                            value = `<span class="text-green">${value}</span>`;
                        }
                    }
                    
                    // Aplicar colores específicos para la nueva tabla
                    if (tableId === 'ids_descripcion_no_encontrados') {
                        if (column === 'id_no_encontrado') {
                            value = `<span class="text-red">${value}</span>`;
                        } else if (column === 'id_beneficiario') {
                            value = `<span class="text-orange">${value}</span>`;
                        }
                    }

/**
 * importar_SD_ODH.js - VERSIÓN CORREGIDA
 * Importa el CSV de SD ODH a MySQL
 */
...
const TABLE_NAME = 'incidentes_SD_ODH';
...
async function importarCSV() {
  ...
  try {
    console.log('🔄 Iniciando proceso de importación SDs ODH...');
    ...
    await conn.commit();
    console.log(`✅ Migración SDs ODH completada: ${ok} insertados | ❌ ${fail} errores`);
...
importarCSV()
  .then(() => {
    console.log('🎉 Proceso de SDs ODH finalizado exitosamente');
    process.exit(0);
  })
  .catch(error => {

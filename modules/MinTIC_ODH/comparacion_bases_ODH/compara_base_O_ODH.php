...
<body id="body" class="<?php echo $_SESSION['dark_mode'] ? 'dark-mode' : ''; ?>">
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="content-area">
            ...
            <!-- Debug Section -->
            <div class="results-container" style="margin-top: 2rem; background: #fff3cd; border-color: #ffeaa7;">
                <div class="results-header">
                    <h2 class="results-title" style="color: #856404;">Información de Depuración</h2>
                </div>
                <div class="table-container">
                    <div class="table-scroll">
                        <table class="comparison-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>Verificar columnas de incidentes</td>
                                    <td>Pendiente</td>
                                    <td>
                                        <button class="refresh-btn" onclick="debugColumnas()" style="background: #17a2b8;">
                        ...
                        <table class="comparison-table" id="tableMotivos">
                            ...
                            <tbody>
                                <?php if (isset($discrepanciasMotivos['error'])): ?>
                                    <tr>
                                        <td colspan="3" class="no-results">
                                            Error: <?php echo $discrepanciasMotivos['error']; ?>
                                        </td>
                                    </tr>
    ...
    <script>
        ...
        // ===== FUNCIONALIDAD PARA DEBUG =====
        function debugColumnas() {
            fetch('compararbasesP_backend.php?accion=debug_columnas')
                .then(response => response.json())
                .then(data => {
                    alert('Columnas en tabla incidentes:\n' + data.join('\n'));
                })
                .catch(error => {

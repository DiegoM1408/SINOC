...
$current_page = 'fuera_horarios_ODH.php';
?>
...
<head>
    ...
    <title>Fuera de Horarios - MinTIC ODH - CLARO NOC</title>
    ...
    <div class="main-content" id="mainContent">
        ...
        <header class="top-header">
            <div class="header-left">
                ...
                <h1>Fuera de Horarios - MinTIC ODH</h1>
            </div>
        ...
        <div class="content-area">
            ...
            <div class="hero-section">
                <div class="hero-content">
                    <h1>⏰ Fuera de Horarios - MinTIC ODH 5G</h1>
                    <p>Auditoría completa de casos que deberían aplicar para PDR de Fuera de Horario según las fechas y horas de incidente. Detecta inconsistencias en horarios FDH y valida la correcta aplicación de criterios.</p>
                    <div class="badges">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <h3>Aplica PDR Fuera Horario</h3>
                        <div class="stat-value" id="count-aplica_pdr_fuera_horario">0</div>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <h3>Corregir Fechas FDH</h3>
                        <div class="stat-value" id="count-corregir_fechas_fdh">0</div>
                    </div>
                </div>
                <div class="stat-card">
            ...
            <div class="section-header">
                ...
                <p class="section-subtitle">Validación de criterios de Fuera de Horarios y corrección de fechas FDH</p>
            </div>
            ...
            <div class="table-container">
                <div class="table-header">
                    <h3>
                        <i class='bx bx-time'></i> Aplica para PDR "Fuera de Horario"
                        <span class="count-badge" id="count-aplica_pdr_fuera_horario_badge">0</span>
                    </h3>
                </div>
            ...
            <div class="table-container">
                <div class="table-header">
                    <h3>
                        <i class='bx bx-calendar-edit'></i> Corregir Fechas de FDH
                        <span class="count-badge" id="count-corregir_fechas_fdh_badge">0</span>
                    </h3>
                </div>
                <div class="table-responsive">
                    <div class="table-scroll-vertical">
    ...
    <script>
            ...
            if (data.rows.length === 0) {
                ...
                data.rows.forEach(row => {
                    ...
                    config.columns.forEach(column => {
                        ...
                        // Resaltar errores en la columna de error_tipo
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            tableContainers.forEach(container => {
                ...
                fetch(`load_fuera_horarios_ODH.php?table=${tableId}`)
                    .then(response => {
                        if (!response.ok) {

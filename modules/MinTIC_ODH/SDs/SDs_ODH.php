<?php
// modules/MinTIC_ODH/SDs/SDs_ODH.php
session_start();
...
<head>
    ...
    <title>SDs - MinTIC ODH - CLARO NOC</title>
        ...
        <div class="content-area">
            ...
            <div class="tab-content active" id="tab-sd-kms">
                ...
                <div class="section-header">
                    ...
                    <p class="section-subtitle">Validación de SDs en proyecto MinTIC ODH</p>
                </div>
                ...
                <div class="audit-grid">
                    ...
                    <!-- Tabla 3: KM24807 sin Cancelled -->
                    <div class="audit-card">
                        <div class="card-header">
                            <span class="card-title">
                                <i class='bx bx-bookmark'></i>
                                KM24807 sin "Cancelled"
                            </span>
